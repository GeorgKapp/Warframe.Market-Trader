...
{
    public class EntityTranslationRepository : IEntityTranslationRepository
    {
        private readonly IAmbientDbContextLocator _ambientDbContextLocator;
        private DbContext DbContext => _ambientDbContextLocator.GetAmbientDbContextOrThrow<EntityContext>();

        public EntityTranslationRepository(IAmbientDbContextLocator ambientDbContextLocator)
        {
